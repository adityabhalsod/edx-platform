...
urlpatterns = oauth2_urlpatterns + [
    ...
    path(
        ...
        openedx.core.djangoapps.lang_pref.views.update_language,
    ...
    re_path(
        rf"^container_embed/{settings.USAGE_KEY_PATTERN}$",
        contentstore_views.container_embed_handler,
    ...
    re_path(
        rf"^assets/{settings.COURSE_KEY_PATTERN}/{settings.ASSET_KEY_PATTERN}/usage",
    ...
    path(
        ...
        include(
            "cms.djangoapps.modulestore_migrator.rest_api.urls",
            namespace="modulestore_migrator_api",
        ),
    ),
    re_path(
    ...
    re_path(
        rf"^xblock/{settings.USAGE_KEY_PATTERN}/action/edit$",
        xblock_edit_view,
    ...
    path(
        "video_features/", contentstore_views.get_video_features, name="video_features"
    ),
    re_path(
    ...
    re_path(
        rf"api/youtube/courses/{COURSELIKE_KEY_PATTERN}/edx-video-ids$",
        contentstore_views.get_course_youtube_edx_videos_ids,
        name="youtube_edx_video_ids",
    ),
    re_path(
        rf"^api/courses/{settings.COURSE_KEY_PATTERN}/bulk_enable_disable_discussions$",
...
urlpatterns.append(
    path(
        "",
        include(
            ("openedx.core.djangoapps.content.search.urls", "content_search"),
...
urlpatterns += [
    path(
        "api/content_tagging/",
        include(("openedx.core.djangoapps.content_tagging.urls", "content_tagging")),
    ),
]
