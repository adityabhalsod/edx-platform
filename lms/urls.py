...
urlpatterns = [
    ...
    path(
        ...
        lang_pref_views.update_language,
    ...
    path(
        "api/dashboard/",
        include(
            "openedx.core.djangoapps.programs.rest_api.urls", namespace="dashboard_api"
        ),
    ),
    path(
        "api/experiments/",
...
if settings.FEATURES.get("ENABLE_MOBILE_REST_API"):
    urlpatterns += [
        re_path(
            r"^api/mobile/(?P<api_version>v(4|3|2|1|0.5))/",
...
urlpatterns += [
    ...
    re_path(
        rf"^videos/embed/{settings.USAGE_KEY_PATTERN}$",
...
urlpatterns += [
    ...
    re_path(
        rf"^courses/{settings.COURSE_ID_PATTERN}/courseware-navigation-sidebar/toggles/$",
...
urlpatterns += [
    path(
        "xqueue/", include((submissions_urls, "submissions"), namespace="submissions")
    ),
]
